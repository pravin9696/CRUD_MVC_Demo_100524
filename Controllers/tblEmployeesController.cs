...
namespace CRUD_MVC_Demo_100524.Controllers
{
    ...
    {
        private DB_EMP_100524Entities db = new DB_EMP_100524Entities();
        ...
        public ActionResult Create([Bind(Include = "id,empName,dept,Salary")] tblEmployee tblEmployee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,empName,dept,Salary")] tblEmployee tblEmployee)
        {
            if (ModelState.IsValid)
            {
